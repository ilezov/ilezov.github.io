...
(() => {
    ...
    function u(t, n, o, l, r) {
        ...
        if (l._editButton && l._saveButton) {
            l._editButton.style.display = "none";
            l._saveButton.style.display = "block";
        }
        l.onblur = () => {
            i(n, false);
            if (Is.definedString(a)) {
    ...
    function b(t, n, o, l) {
        if (t.controlPanel.enabled) {
            ...
            if (t.allowEditing.bulk && t.controlPanel.showEditButton) {
                ...
                const a = DomElement.createWithHTML(i, "button", "control-button save", e.text.saveSymbolButtonText);
                a.style.display = "none";
                a.onclick = () => c(t, n, l);
                a.ondblclick = DomElement.cancelBubble;
                ToolTip.add(a, t, e.text.saveButtonText);
                n._editButton = r;
                n._saveButton = a;
            }
    ...
    function H(t, n) {
        ...
        a.onclick = () => R(n, o, true);
        s.onclick = () => R(n, o, false);
    ...
    function Y(t, n, o, l, r) {
        ...
        if (s !== 0 || !n.ignore.emptyObjects) {
            ...
            X(f, null, d, n, i, a, p, x, false, true, "", r, r !== "object", 1);
            ae(n, m, i, r, false);
            Z(n, i, m);
            q(n, i, m);
    ...
    function K(t, n, o, l) {
        ...
        if (n.hideRootObjectNames) {
            a.style.display = "none";
            s.classList.add("root-item");
        }
        G(u, null, s, n, o, d, f, false, true, "", l, l !== "array", 1);
        ae(n, c, o, l, false);
        Z(n, o, c);
        q(n, o, c);
        me(n, a, false, o, o, null, false, null);
    }
    function X(t, n, o, l, r, i, a, s, u, c, d, f, g, m) {
        let p = true;
        const x = i.length;
        const T = d !== "" ? x : 0;
    ...
    function G(t, n, o, l, r, i, a, s, u, c, d, f, g) {
        let m = true;
        const p = r.length;
        const x = c !== "" ? p : 0;
    ...
    function ee(t, n, o, l, r, i, a, s, u, c, d) {
        ...
        if (Is.defined(E) && E !== false) {
            ...
            if (!o.ignore.htmlValues) {
                ...
                if (l === 0 && o.ignore.emptyObjects) {
                    ...
                    const p = ue(o, r, i);
                    const T = X(m, p, a, o, t, n, u, c, true, i, s, y, true, d + 1);
            ...
            if (!o.ignore.setValues) {
                ...
                const c = ue(o, n, i);
                const p = G(m, c, l, o, t, a, u, true, i, s, y, true, d + 1);
            ...
            if (!o.ignore.arrayValues) {
                ...
                const u = ue(o, t, i);
                const c = G(m, u, n, o, r, l, a, true, i, s, y, false, d + 1);
            ...
            if (!o.ignore.objectValues) {
                ...
                if (n === 0 && o.ignore.emptyObjects) {
                    ...
                    const p = ue(o, l, i);
                    const T = X(m, p, a, o, r, t, u, c, true, i, s, y, false, d + 1);
                    if (!T && o.showOpeningClosingCurlyBraces) {
                        u.parentNode.removeChild(u);
                        c.parentNode.removeChild(c);
                    }
    ...
    function re(e, t, n, o, l, r, i, a = null) {
        if (i) {
            l.ondblclick = i => {
                ie(i, e, t, n, o, l, r, a);
            };
    ...
    function ie(t, n, o, l, r, a, s, u = null) {
        let c = null;
        DomElement.cancelBubble(t);
        clearTimeout(n._currentView.valueClickTimerId);
        n._currentView.valueClickTimerId = 0;
    ...
    function me(t, n, o, l, r, i, a, s) {
        n.oncontextmenu = u => {
            ...
            if (o && t._currentView.selectedValues.length <= 1) {
                ...
                o.onclick = e => pe(e, t, n, l, i, r, a, s);
            }
