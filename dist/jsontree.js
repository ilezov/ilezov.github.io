...
(e => {
    ...
    (t => {
        ...
        function o(e) {
            ...
            t.jsonIndentSpaces = Default.getNumber(t.jsonIndentSpaces, 4);
...
(e => {
    ...
    (e => {
        ...
        function n(e) {
            ...
            e.text.editSymbolButtonText = Default.getAnyString(e.text.editSymbolButtonText, "✏️");
            e.text.editButtonText = Default.getAnyString(e.text.editButtonText, "Edit");
            e.text.saveSymbolButtonText = Default.getAnyString(e.text.saveSymbolButtonText, "💾");
            e.text.saveButtonText = Default.getAnyString(e.text.saveButtonText, "Save");
...
(() => {
    ...
    function a(t, n, o, l, r, i, s) {
        ...
        if (!Is.defined(t)) {
            ...
            const d = o._currentView.currentColumnBuildingIndex;
            a.onscroll = () => f(a, o, d);
            if (Is.definedArray(t)) {
                K(e, o, t, "array");
            } else if (Is.definedSet(t)) {
                K(e, o, Convert2.setToArray(t), "set");
            } else if (Is.definedHtml(t)) {
                Y(e, o, Convert2.htmlToObject(t, o.showCssStylesForHtmlObjects), l, "html");
            } else if (Is.definedMap(t)) {
                Y(e, o, Convert2.mapToObject(t), l, "map");
            } else if (Is.definedObject(t)) {
                Y(e, o, t, l, "object");
            } else {
                Y(e, o, Obj.createFromValue(t), l, "object");
            }
            T(o._currentView.currentColumnBuildingIndex, o);
            b(o, a, t, l);
            if (Is.defined(r)) {
                a.scrollTop = r;
            }
            if (o._currentView.titleBarButtons) {
    ...
    function u(t, n, o, l, r) {
        ...
        const s = l._editButton;
        const a = l._saveButton;
        const d = l.querySelector(".column-control-buttons");
        console.log("Edit mode activated with CodeMirror");
        console.log("Edit button:", s);
        console.log("Save button:", a);
        console.log("Control buttons container:", d);
        l.classList.add("editable");
        l.classList.add("jsontree-js-scroll-bars");
        l.setAttribute("draggable", "false");
        l.innerHTML = "";
        const f = JSON.stringify(Convert2.toJsonStringifyClone(o, e, n), n.events.onCopyJsonReplacer, n.jsonIndentSpaces);
        const g = document.createElement("div");
        g.className = "codemirror-editor-container";
        g.style.cssText = "height: 100%; width: 100%; overflow: auto;";
        l.appendChild(g);
        if (typeof window.JsonEditor !== "undefined") {
            const e = window.JsonEditor;
            const t = e.createEditorState(f);
            const n = e.createEditorView(t, g);
            l._codeMirrorEditor = n;
            console.log("CodeMirror editor initialized");
        } else {
            console.error("CodeMirror not loaded!");
            g.innerHTML = '<pre style="margin: 0; padding: 10px; font-family: monospace;">' + f + "</pre>";
        }
        if (d) {
            l.appendChild(d);
            if (a) {
            ...
            if (s) {
                s.onmousedown = e => {
                    e.preventDefault();
                    console.log("Edit button clicked (should not happen in edit mode)");
                    u(null, n, o, l, r);
                };
            }
        }
        if (s && a) {
            console.log("Switching buttons: hiding edit, showing save");
    ...
    function c(t, n, o) {
        let l = null;
        let r = "";
        const s = n._codeMirrorEditor;
        if (s) {
            r = s.state.doc.toString();
            console.log("Saving JSON from CodeMirror:", r);
        } else {
            const e = n.querySelector(".column-control-buttons");
            if (e) {
                e.remove();
            }
            r = n.innerText;
            console.log("Saving JSON from innerText:", r);
        }
        const a = Convert2.jsonStringToObject(r, e);
        console.log("Parsed result:", a);
        if (a.parsed) {
            l = e.text.jsonUpdatedText;
            if (t.paging.enabled && Is.definedArray(t.data)) {
                if (Is.defined(a.object)) {
                    t.data[o] = a.object;
                } else {
                    t.data.splice(o, 1);
                    l = e.text.arrayJsonItemDeleted;
                    if (o === t._currentView.currentDataArrayPageIndex && t._currentView.currentDataArrayPageIndex > 0) {
    ...
    function f(e, t, n) {
        ...
        for (let n = 0; n < r; n++) {
            ...
            if (r.column !== e) {
                ...
                if (t.controlPanel.enabled && r.controlButtons) {
    ...
    function p(e, t) {
        ...
        x(e, e._currentView.columnDraggingDataIndex, t);
    }
    function x(t, n, o) {
        if (n !== o) {
            const l = t.data[o];
    ...
    function b(t, n, o, l) {
        if (t.controlPanel.enabled) {
            ...
            if (!Is.defined(i)) {
                console.error("Failed to create control buttons container");
                return;
            }
            ...
            if (t.allowEditing.bulk && t.controlPanel.showEditButton) {
                ...
                if (!Is.defined(r)) {
                    console.error("Failed to create edit button");
                    return;
                }
                r.onclick = () => u(null, t, o, n, l);
                r.ondblclick = DomElement.cancelBubble;
                ToolTip.add(r, t, e.text.editButtonText);
                const s = DomElement.createWithHTML(i, "button", "control-button save", e.text.saveSymbolButtonText);
                if (!Is.defined(s)) {
                ...
                s.style.display = "none";
                s.onclick = () => c(t, n, l);
                s.ondblclick = DomElement.cancelBubble;
                ToolTip.add(s, t, e.text.saveButtonText);
                n._editButton = r;
                n._saveButton = s;
                console.log("Buttons created and attached successfully");
            }
    ...
    function E(t, n) {
        if (t.title.show && (Is.definedString(t.title.text) || t.title.showCloseOpenAllButtons || t.title.showCopyButton || t.sideMenu.enabled || t.paging.enabled || t.title.enableFullScreenToggling)) {
            ...
            if (t.paging.enabled && Is.definedArray(n) && n.length > 1) {
                ...
                if (t._currentView.currentDataArrayPageIndex > 0) {
                    t._currentView.backPageButton.onclick = () => O(t);
                } else {
                ...
                if (t._currentView.currentDataArrayPageIndex + (t.paging.columnsPerPage - 1) < n.length - 1) {
                    t._currentView.nextPageButton.onclick = () => M(t);
                } else {
            ...
            if (t.title.enableFullScreenToggling && t.title.showFullScreenButton) {
                ...
                t._currentView.toggleFullScreenButton.onclick = () => I(t);
    ...
    function L(e) {
        ...
        e._currentView.disabledBackground.onclick = () => k(e);
    }
    function j(t) {
        if (t.sideMenu.enabled) {
    ...
    function H(t, n) {
        ...
        s.onclick = () => R(n, o, true);
        a.onclick = () => R(n, o, false);
    ...
    function Y(t, n, o, l, r) {
        ...
        if (a !== 0 || !n.ignore.emptyObjects) {
            ...
            X(f, null, d, n, i, s, p, x, false, true, "", r, r !== "object", 1);
            se(n, m, i, r, false);
            Z(n, i, m);
            q(n, i, m);
            me(n, c, false, i, i, null, false, null);
        }
    }
    function K(t, n, o, l) {
        let r = o;
        ...
        G(u, null, a, n, o, d, f, false, true, "", l, l !== "array", 1);
        se(n, c, o, l, false);
        Z(n, o, c);
        q(n, o, c);
        me(n, s, false, o, o, null, false, null);
    }
    function X(t, n, o, l, r, i, s, a, u, c, d, f, g, m) {
        let p = true;
        const x = i.length;
        const T = d !== "" ? x : 0;
        if (x === 0 && !l.ignore.emptyObjects) {
            ee(r, o, l, "", e.text.noPropertiesText, true, false, "", f, g, m);
            p = false;
        } else if (l.maximum.inspectionLevels > 0 && m > l.maximum.inspectionLevels) {
            ee(r, o, l, "", e.text.maximumInspectionLevelsReached, true, false, "", f, g, m);
            p = false;
        } else {
            for (let e = 0; e < x; e++) {
                const t = i[e];
                ...
                if (r.hasOwnProperty(t)) {
                    ee(r, o, l, t, r[t], e === x - 1, false, n, f, g, m);
                }
            }
    ...
    function G(t, n, o, l, r, i, s, a, u, c, d, f, g) {
        let m = true;
        const p = r.length;
        const x = c !== "" ? p : 0;
        if (l.maximum.inspectionLevels > 0 && g > l.maximum.inspectionLevels) {
            ee(r, o, l, "", e.text.maximumInspectionLevelsReached, true, false, "", d, f, g);
            m = false;
        } else {
            if (!l.reverseArrayValues) {
                for (let e = 0; e < p; e++) {
                    ...
                    ee(r, o, l, Arr.getIndexName(l, t, p), r[e], e === p - 1, true, n, d, f, g);
                }
            } else {
                for (let e = p; e--; ) {
                    const t = Arr.getIndex(e, l);
                    const n = c === "" ? t.toString() : `${c}${"\\"}${t}`;
                    ee(r, o, l, Arr.getIndexName(l, t, p), r[e], e === 0, true, n, d, f, g);
                }
            }
            if (o.children.length === 0 || l.showOpenedObjectArrayBorders && o.children.length === 1) {
                ee(r, o, l, "", e.text.noPropertiesText, true, false, "", d, f, g);
                m = false;
            } else {
    ...
    function ee(t, n, o, l, r, i, s, a, u, c, d) {
    ...
    function re(e, t, n, o, l, r, i, s = null) {
        if (i) {
            l.ondblclick = i => {
                ie(i, e, t, n, o, l, r, s);
            };
    ...
    function ie(t, n, o, l, r, s, a, u = null) {
        let c = null;
        DomElement.cancelBubble(t);
        clearTimeout(n._currentView.valueClickTimerId);
        n._currentView.valueClickTimerId = 0;
    ...
    function _e(e, l) {
        ...
        if (l.shortcutKeysEnabled && n === 1 && t.hasOwnProperty(l._currentView.element.id) && !l._currentView.editMode) {
            if (Oe(e) && e.key.toLowerCase() === "c") {
                e.preventDefault();
                C(l, l.data);
            } else if (Oe(e) && e.key === "F11") {
                e.preventDefault();
                I(l);
